	...
	<div class="about">
		...
		>
			...
			<el-form-item label="购进指标：" >
				...
				<el-input width="350" class="ml-15" placeholder="输入金额/数量" disabled ></el-input>
			</el-form-item>
			<el-form-item label="纯销指标：" >
				<el-select style="width:88px;" v-model="formInline.region" placeholder="">
					<el-option label="正常" value="shanghai" />
					<el-option label="不正常" value="beijing" />
				</el-select>
				<el-input width="350" class="ml-15" placeholder="输入金额/数量" disabled ></el-input>
			...
			<el-form-item label="销售渠道：" >
				...
				<!-- <el-tag class="ml-15" style="height: 30px;" closable type="success">全国</el-tag> -->
  				<el-tag class="ml-15" style="height: 30px; width: 80px;" closable tsype="info">全国</el-tag>
			</el-form-item>
			<el-form-item label="签订时间：" >
				<el-input style="width:455px ;"  placeholder="输入金额/数量" disabled ></el-input>
			</el-form-item>
			<el-form-item label="购进指标：" >
				<el-select style="width:100px;" v-model="formInline.type" placeholder="">
			...
			<div style="padding-left: 100px; width: 100%;">
				<el-table :data="tableData" :scrollbar-always-on="false" style="width: 100%; ">
		...
		<div class="contianer">
			<div class="contianer-header">
				...
				<div class="text">指标按季度分解（万元）：<span>【Q1】￥12.5，【Q2】￥12.5，【Q3】￥12.5，【Q4】￥12.5</span></div>
					...
					<div class="tab-item" style="margin-top:10px">
						<div class="item" v-for="item in prdTableDataLsit2" :key="item.id">
							...
							<div class="tr">
								...
								<template v-else>
									<el-select class="tab-input"  v-model="item.type" placeholder="">
										<el-option  :label="select.label" :value="select.value" v-for="select in item.typeData" />
									</el-select>
								</template>
							</div>
						</div>
...
const prdTableDataLsit2 = reactive([
	...
	{id: 2, name:'费用科目', domType: 'select', type:'单选1', typeData:[{label:'单选1', value: '单选1'},{label:'多选2', value: '多选2'}]},
	{id: 3, name:'零售配送', domType:'input'},
	{id: 4, name:'费用科目', domType: 'select' ,type:'多选项2', typeData:[{label:'单选1', value: '单选1'},{label:'多选2', value: '多选2'}]},
	{id: 5, name:'医疗配送商', domType:'input'},
	{id: 6, name:'费用科目', domType: 'select' ,type:'多选项2', typeData:[{label:'单选1', value: '单选1'},{label:'多选2', value: '多选2'}]},
